...
typedef NativeStreamOpenC = Int32 Function(Pointer<Uint8>, IntPtr, Uint32, Uint32, Pointer<Uint64>, Pointer<NativeAnimatedImageStreamMetadataNative>);
typedef NativeStreamOpen = int Function(Pointer<Uint8>, int, int, int, Pointer<Uint64>, Pointer<NativeAnimatedImageStreamMetadataNative>);
typedef NativeStreamNextFrameC = Int32 Function(Uint64, Pointer<Pointer<Uint8>>, Pointer<IntPtr>, Pointer<Uint32>, Pointer<Uint32>, Pointer<Uint32>);
typedef NativeStreamNextFrame = int Function(int, Pointer<Pointer<Uint8>>, Pointer<IntPtr>, Pointer<Uint32>, Pointer<Uint32>, Pointer<Uint32>);
typedef NativeStreamCloseC = Void Function(Uint64);
typedef NativeStreamClose = void Function(int);

final class NativeAnimatedImageStreamMetadataNative extends Struct {
...
NativeStreamOpen lookupStreamOpen(DynamicLibrary lib) => lib.lookupFunction<NativeStreamOpenC, NativeStreamOpen>('native_animated_image_stream_open');
NativeStreamNextFrame lookupStreamNextFrame(DynamicLibrary lib) => lib.lookupFunction<NativeStreamNextFrameC, NativeStreamNextFrame>('native_animated_image_stream_next_frame');
NativeStreamClose lookupStreamClose(DynamicLibrary lib) => lib.lookupFunction<NativeStreamCloseC, NativeStreamClose>('native_animated_image_stream_close');
