...
class _InlineSpanTextState extends State<InlineSpanText> {
  ...
  Widget build(BuildContext context) {
    ...
    final useDirectPaint =
        !InlineSpanText.debugForceRichText &&
    ...
    if (useDirectPaint) {
      ...
      ParagraphWarmupProbe.noteStyle(widget.baseStyle, theme, widget.flattener);
    }
    ...
    return SelectableTextBox(
      ...
      child: useDirectPaint
          ? CachedParagraphText(result: result, textAlign: widget.textAlign)
          : Text.rich(
              result.span,
