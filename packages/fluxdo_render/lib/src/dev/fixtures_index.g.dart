...
''',
    notes:
        r'''深三层嵌套 quote(aside > blockquote > aside > blockquote > aside > blockquote)。
...
历史上 fwfh 在这种 case 上偶有"丢失中间层"的问题。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p><a class="attachment" href="/secure-uploads/original/2X/f/f62055931bb702c7fd8f552fb901f977e0289a18.zip">archive.zip</a> (4.5 MB)</p>''',
    notes:
        r'''secure-uploads 路径附件(鉴权下载)。验证 isAttachment 仍命中、filename=archive.zip。
...
primary_node 标 attachment(与目录同名)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>详见附件 <a class="attachment" href="/uploads/default/original/1X/abc123def456.pdf">设计规范.pdf</a> (1.2 MB)。</p>''',
    notes:
        r'''最基础附件链接 a.attachment(Discourse `[设计规范.pdf|attachment](upload://…)`
...
''',
    notes:
        r'''Discourse 上传音频的终态 cooked(无运行时注入):<audio preload="metadata" controls>
...
(主项目 audioBuilder 分流);子包 fallback 仍是占位卡。''',
    source:
        r'''cook 探针实测(tools/discourse-cook-bundle,[wrap=voice] BBCode 产物)''',
    edgeCase: false,
  ),
  FixtureEntry(
...
渲染:橙色 + warning_amber 图标 + 标题 "操作不可逆" + 两段内容。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="chat-transcript chat-transcript-chained" data-username="bob" data-datetime="2026-02-12T10:31:00Z">
...
验证 isChained → 去边框 + margin 0,紧贴上一条。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="chat-transcript" data-message-id="123" data-username="alice" data-datetime="2026-02-12T10:30:00Z" data-channel-name="general">
...
纯 DOM,主项目接 legacy buildChatTranscript;子包 fallback 卡。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>查看 <a href="https://example.com/post/123">这条帖子</a> <span class="click-count"> 42 </span> 和 <a href="https://example.com/post/456">另一条</a> <span class="click-count"> 1.2k </span>。</p>
''',
...
渲染:链接后跟小灰底圆角 chip(10 字号)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>大点击数:<span class="click-count"> 12.3k </span>;小点击数:<span class="click-count"> 5 </span>;还有 <span class="click-count">空格已被 trim 仅数字 100</span>。</p>
''',
...
CodeBlockNode.code 是字面值 ">"。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<pre><code class="lang-bash">flutter run -d macos --dart-define=FLAVOR=staging --observatory-port=9100 --enable-vm-service --disable-service-auth-codes
...
点击箭头展开,heightFactor 200ms easeInOut。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>自定义表情 <img src="https://cdn.example.com/uploads/custom/bili_114.gif" alt=":bili_114:" class="emoji emoji-custom" title=":bili_114:"> 来自 Discourse。</p>
''',
...
附加 `emoji-custom` class 不影响 parser(只检查 `emoji`)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<h2>H2 标题里 <img src="https://example.com/images/emoji/twitter/star.png?v=12" alt=":star:" class="emoji" title=":star:"> 的 emoji</h2>
...
baseStyle.fontSize 传给 emojiBuilder 作 size)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>多个表情 <img src="https://example.com/images/emoji/twitter/smile.png?v=12" alt=":smile:" class="emoji" title=":smile:"> <img src="https://example.com/images/emoji/twitter/heart.png?v=12" alt=":heart:" class="emoji" title=":heart:"> <img src="https://example.com/images/emoji/twitter/fire.png?v=12" alt=":fire:" class="emoji" title=":fire:"> 一起。</p>
''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p><img src="https://example.com/images/emoji/twitter/tada.png?v=12" alt=":tada:" class="emoji only-emoji" title=":tada:"></p>
''',
...
验证 EmojiRun.isOnlyEmoji 解析 + 32px 显示。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>Hello <img src="https://example.com/images/emoji/twitter/heart.png?v=12" alt=":heart:" class="emoji" title=":heart:"> world.</p>
''',
...
WidgetSpan 渲染 + 1em 字号(跟 baseStyle 一致)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>含 <strong>加粗</strong>、<em>斜体</em>、<code>code</code> 和脚注 <sup class="footnote-ref"><a href="#fn:x">1</a></sup> 的混合段。</p>
...
无 hr.footnotes-sep(部分 cooked 形态省略)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>第一个 <sup class="footnote-ref"><a href="#fn:a">1</a></sup>,第二个 <sup class="footnote-ref"><a href="#fn:b">2</a></sup>,第三个 <sup class="footnote-ref"><a href="#fn:c">3</a></sup>。</p>
...
''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>第一处引用 <sup class="footnote-ref"><a href="#fn:1">1</a></sup>,第二处引用 <sup class="footnote-ref"><a href="#fn:2">2</a></sup>。</p>
<hr class="footnotes-sep">
<section class="footnotes">
<ol class="footnotes-list">
...
正文条目保留链接/加粗;上标 popover 与底部列表并存。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>正文中引用脚注 <sup class="footnote-ref"><a href="#fn:1">1</a></sup> 一下。</p>
<hr class="footnotes-sep">
<section class="footnotes">
<ol class="footnotes-list">
...
+ 上下 12 padding。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<iframe src="https://codepen.io/team/codepen/embed/PNaGbb" sandbox="allow-scripts allow-same-origin" referrerpolicy="no-referrer" loading="lazy" width="600" height="400"></iframe>
''',
...
+ lazyLoad=true + referrerPolicy="no-referrer"。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<iframe data-src="https://player.bilibili.com/player.html?bvid=BVxxx" width="800" height="450"></iframe>
''',
...
parser 应该 fallback 到 data-src。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" width="560" height="315" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen title="嵌入的 YouTube 视频"></iframe>
''',
    notes:
        r'''YouTube 嵌入 iframe(典型 16:9 + allowfullscreen + allow Permissions Policy)。
...
sha256 占位:本 fixture 为新引擎构造样例非线上抓取,提交前可用真实 cooked 替换并重算。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>点击查看大图:<a href="https://example.com/lightbox/foo"><img src="https://example.com/upload/thumb.png" alt="thumbnail" width="100" height="100"></a></p>
''',
...
没修之前:全靠 fallback textContent 把 .meta 文字渲染成 "filename 尺寸 KB"。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>对比图:<img src="https://example.com/upload/before.png" alt="before" width="120" height="80"> 和 <img src="https://example.com/upload/after.png" alt="after" width="120" height="80"></p>
''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<picture><source srcset="https://example.com/upload/hero-480.webp 480w, https://example.com/upload/hero-960.webp 960w" type="image/webp"><img src="https://example.com/upload/hero.png" alt="响应式图片" width="480" height="270"></picture>
''',
...
sha256 占位:同 figure_with_caption,提交前可替换为真实 cooked 并重算。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>看这张截图:<img src="https://example.com/upload/screenshot.png" alt="screenshot"></p>
''',
...
各自独立段落。这是图片帖正文最常见的形态。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>固定尺寸的图:<img src="https://example.com/upload/diagram.png" alt="diagram" width="200" height="120"></p>
''',
...
正确的占位框。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="d-image-grid d-image-grid--carousel" data-mode="carousel">
...
渲染:Wrap 两列,每瓦片有 lightboxUrl(可点查看大图)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>查看 <a href="https://api.flutter.dev/flutter/widgets/RichText-class.html"><code>RichText</code> 文档</a> 了解细节。</p>
''',
...
覆盖 code 文本。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>长命令示例:<code>flutter run -d macos --dart-define=FLAVOR=staging --observatory-port=9100</code> 在终端里换行也要正常显示。</p>
''',
...
阶段 5 自研 paint 时补齐(对应 InlineCodePainter 跨行 RRect 合并)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>常用命令有 <code>git status</code>、<code>git diff</code> 和 <code>git log</code>,各自查看不同信息。</p>
''',
...
成 < > & ",InlineCodeRun.text 应是字面值。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>asdfas<strong>dfasdf</strong>asdf<code>asdf</code>as<strong>dfasdf</strong><code>codex Sign-in failed: {"code":-32603...(os error 10013)"}</code></p>
''',
...
灰底背景错位/溢出到相邻文字的场景,此处去掉 spoiler 容器以隔离变量。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="lazy-video-container" data-video-id="7234567890123456789" data-video-title="" data-video-start-time="" data-provider-name="tiktok">
...
品牌色近黑(#010101)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="lazy-video-container" data-video-id="123456789" data-video-title="A Vimeo Sample" data-video-start-time="1m30s" data-provider-name="vimeo">
...
品牌色蓝青(#1AB7EA)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="lazy-video-container" data-video-id="dQw4w9WgXcQ" data-video-title="Sample YouTube Video" data-video-start-time="0" data-provider-name="youtube">
...
渲染:16:9 缩略图 + 红色播放按钮 + 标题栏(可点跳 youtube url)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>手工构造的裸 lightbox 链接:<a class="lightbox" href="https://example.com/uploads/original/artwork.png" title="artwork.png" rel="noopener nofollow ugc"><img src="https://example.com/uploads/optimized/artwork_600x400.png" alt="artwork" width="600" height="400"></a> 点开进 gallery。</p>
''',
...
都能在 li 内正确渲染(包括 LinkRun recognizer + EmojiRun WidgetSpan)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>距离开抢还有 <span class="discourse-local-date" data-date="2026-10-01" data-time="00:00" data-timezone="Asia/Shanghai" data-countdown="true">3 小时</span>!</p>
''',
...
fallback 渲染:时钟图标(schedule_rounded)+ 服务端预渲染 "3 小时"。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>仅日期:<span class="discourse-local-date" data-date="2026-12-25" data-format="LL">2026年12月25日</span> 圣诞节。</p>
''',
...
fallback 渲染:服务端文本 "2026年12月25日"。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>会议时间:<span class="discourse-local-date" data-date="2026-08-15" data-time="14:30" data-timezone="Asia/Shanghai" data-timezones="Europe/Paris|America/Los_Angeles" data-format="LLL">2026年8月15日 下午2:30</span>,请提前 10 分钟到场。</p>
''',
...
主项目接 mathBlockBuilder 后会用 flutter_math_fork 渲染真公式。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>欧拉恒等式 <span class="math">e^{i\pi} + 1 = 0</span> 是数学中最美的公式之一。</p>
''',
...
验证两种节点都能正确识别 + 段间隔合理。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>问题反馈给 <a class="mention" href="/u/team_support">@team_support</a> 组,而不是个人。</p>
''',
...
确保 parser 不对 username 形态(下划线 / 短横线)做特殊处理。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>多人 <a class="mention" href="/u/alice">@alice</a> <a class="mention" href="/u/bob">@bob</a> <a class="mention" href="/u/charlie">@charlie</a> 同时参与。</p>
''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>普通用户链接 <a href="/u/bob">@bob</a> 没有 class=mention,应该走普通 LinkRun。这种形态由主项目 mentionedUsers 列表识别后追加 class,parser 阶段不该主动猜。</p>
''',
...
chip 样式渲染(灰底圆角 + primary 字 + 0.82em)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>状态用户 <a class="mention" href="/u/alice">@alice<img src="https://example.com/images/emoji/twitter/fire.png?v=12" class="emoji mention-status" alt=":fire:" title=":fire:" style="width:14px;height:14px;vertical-align:middle;margin-left:2px"></a> 在线。</p>
''',
...
应识别为 OneboxKind.defaultKind。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<aside class="onebox githubpullrequest" data-onebox-src="https://github.com/owner/repo/pull/123">
<header class="source">
...
legacy 完整版含作者头像 / 文件统计等,主项目 oneboxBuilder 可接管。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<aside class="onebox youtube-onebox" data-onebox-src="https://www.youtube.com/watch?v=dQw4w9WgXcQ">
<header class="source">
...
居中诗句走 <div align="center"> → 段落 textAlign。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>行内着色:<span style="color:#e03e2d">红色警告</span>、<span style="color:green">绿色通过</span>、<span style="background-color:#25AAE2">蓝底高亮</span>,以及<span style="color:#ffffff;background-color:#000000">白字黑底</span>组合。</p>
''',
...
background-color 底色、字色+底色组合 → ColoredRun。守护"红字不显示"那类缺口。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>行内样式合集:<u>下划线</u>、<s>删除线</s>、<del>已删</del>、<ins>新增</ins>、<small>小字</small>、<big>大字</big>、<mark>高亮</mark>、<kbd>Ctrl</kbd>+<kbd>V</kbd>、化学式 H<sub>2</sub>O 与公式 E=mc<sup>2</sup>。</p>
''',
...
覆盖 StyledRun 各 kind,守护 fwfh 对齐。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>含 <svg class="fa d-icon d-icon-far-image svg-icon" aria-hidden="true"><use href="#far-image"></use></svg> 图标的段落,svg 应该完全跳过,不留任何文字噪音。</p>
''',
...
无下划线、不可点。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>内部链接示例:<a href="/t/topic/12345/3">某个话题</a> 和 <a href="/u/alice">某个用户</a>。</p>
''',
...
(下划线 + 可点击)。link 不是 NodeKind,fixture 归属 paragraph。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>包含 <a href="https://example.com"><strong>粗体</strong> 和 <em>斜体</em></a> 的链接。</p>
''',
...
''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>外层 <em>外层斜体 <strong>嵌套粗体 <em>双重斜体</em> 后续</strong> 后续</em> 收尾</p>
''',
...
''',
    notes:
        r'''块级对齐:<div align="center"> / <p style="text-align:right"> / <center>。
...
''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="policy" data-version="2" data-groups="trust_level_1,staff" data-accept="我已阅读并同意" data-revoke="我反悔了" data-renewal-days="90" data-reminder="weekly">
...
主项目接 policyBuilder 后会替换为带后端 API 的真实交互。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="poll" data-poll-name="favorite" data-poll-question="你最喜欢哪个?" data-poll-type="multiple">
...
''',
    notes:
        r'''带标题 poll(data-poll-question + .poll-title + data-poll-name=favorite)。
验证 parser 标题提取优先级 + 自定义 pollName。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<div class="poll" data-poll-name="poll" data-poll-type="regular" data-poll-status="open">
<div class="poll-container">
<ul>
...
主项目接 pollBuilder 后 legacy buildPoll 从 post.polls 渲染真实选项/票数。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<aside class="quote" data-username="outer_user" data-post="2" data-topic="111">
<div class="title">
...
build,每层都有自己的灰底 + 头像。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<aside class="quote" data-username="dave" data-post="7" data-topic="999">
<blockquote>
...
首字母 chip fallback。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<aside class="quote no-group" data-username="alice" data-post="1" data-topic="999">
<div class="title">
...
这是 Discourse 最常见的"@回复"形态。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<aside class="quote quote-modified" data-post="1" data-topic="2369360">
<div class="title">
<div class="quote-controls"></div>
...
保留标题 emoji/链接、category 结构化提取(名称/底色/文字色/链接),对齐 legacy。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<aside class="quote" data-username="charlie" data-post="5" data-topic="999">
<div class="title">
...
在 blockquote 内递归正常,所有 inline + block 都能在 quote 内显示。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<aside class="quote" data-username="bob" data-post="3" data-topic="999">
<div class="title">
<div class="quote-controls"></div>
...
显示 "42"。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>含 <span class="spoiler">关键 <strong>剧情</strong></span> 和 <span class="spoiler"><a href="https://example.com">线索链接</a></span> 的句子。</p>
''',
...
可以承载任意 inline 节点;揭示后嵌套样式 + 链接全部生效(link 可点)。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p>含图标 <svg class="fa d-icon d-icon-far-image svg-icon" aria-hidden="true"><use href="#far-image"></use></svg> 的段落,d-icon 应被跳过不产 SvgNode。</p>
''',
...
columnCount = max = 3;缺列补空,多列正常显示。''',
  ...
  FixtureEntry(
    ...
    html:
        r'''<p><div class="video-placeholder-container" data-video-src="/uploads/default/original/1X/abcdef1234567890.mp4" data-thumbnail-src="/uploads/default/optimized/1X/abcdef_thumb.png" data-orig-src="upload://eyPnj7UzkU0AkGkx2dx8G4YM1Jx.mp4">
</div></p>
''',
    notes:
        r'''Discourse 上传视频的主形态(linux.do):cooked 里只有空 div.video-placeholder-container
...
''',
    notes:
        r'''旧式/直链视频形态:div.onebox.video-onebox 内含真 <video controls> + <source>。
