...
void main() {
  ...
  group('ListNode', () {
    ...
    test('ListItem.children 嵌套子列表正常 ==', () {
      const sub = ListNode(
        ...
        depth: 1,
        items: [
          ListItem(inlines: [TextRun('nested')]),
        ],
      );
      const a = ListItem(inlines: [TextRun('outer')], children: [sub]);
      const b = ListItem(inlines: [TextRun('outer')], children: [sub]);
      expect(a, b);
      expect(a.hashCode, b.hashCode);
    });
  ...
  group('BlockquoteNode', () {
    test('==/hashCode 按 children 比较(id 不参与)', () {
      const a = BlockquoteNode(
        id: 'b_0',
        children: [
          ParagraphNode(id: 'b_1', inlines: [TextRun('x')]),
        ],
      );
      const b = BlockquoteNode(
        id: 'b_99',
        children: [
  ...
  group('QuoteCardNode', () {
    test('==/hashCode 按 username/avatarUrl/title/href/topic/post/children', () {
      ...
      const b = QuoteCardNode(
        ...
        postNumber: 3,
        children: [
          ParagraphNode(id: 'b_2', inlines: [TextRun('x')]),
        ],
      );
      expect(a, b);
    ...
    test(
      'avatarUrl / titleText / titleHref / topicId / postNumber 默认 null',
      () {
  ...
  group('SpoilerBlockNode', () {
    ...
    test('toString 含 id + 子数', () {
      const s = SpoilerBlockNode(
        id: 'b_3',
        children: [ParagraphNode(id: 'b_4', inlines: [])],
      );
