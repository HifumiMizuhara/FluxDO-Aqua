...
class GrainGradient extends StatefulWidget {
  ...
  @override
  State<GrainGradient> createState() => _GrainGradientState();
}

class _GrainGradientState extends State<GrainGradient>
    ...
    try {
      final results = await Future.wait([
        ui.FragmentProgram.fromAsset(
          'packages/paper_shaders/shaders/grain_gradient.frag',
        ),
        _getNoiseTexture(),
      ]);
  ...
  Widget build(BuildContext context) {
    ...
    final noiseTexture = _noiseTexture;

    Widget content;
    if (shader == null || noiseTexture == null) {
      // 加载中，用背景色占位
      content = ColoredBox(color: widget.backgroundColor);
    } else {
      content = CustomPaint(
        painter: GrainGradientPainter(
          shader: shader,
