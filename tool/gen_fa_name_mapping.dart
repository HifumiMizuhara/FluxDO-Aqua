...
void main(List<String> args) {
  ...
  final iconUrlReg = RegExp(
    r'https://fontawesome.com/icons/([^?]+)\?style=([a-z]+)',
  );
  final iconConstReg = RegExp(
    r'static const (?:IconData|FaIconData) ([A-Za-z0-9_]+) = ',
  );
  ...
  out.writeln('FaIconData? getIconFromCss(String cssClasses) {');
  ...
  out.writeln('const Map<String, FaIconData> faIconNameMapping = {');
