...
class _BookmarkEditSheetState extends State<BookmarkEditSheet> {
  ...
  void initState() {
    ...
    writeBookmarkEditTrace(
      ...
      traceId: _traceId,
      source: _traceSource,
      message: 'Bookmark editor panel initialized',
  ...
  Future<void> _save() async {
    ...
    writeBookmarkEditTrace(
      ...
      traceId: _traceId,
      source: _traceSource,
      message: 'Bookmark editor panel started saving',
      topicId: widget.topicId,
      postId: widget.postId,
      bookmarkId: widget.bookmarkId,
    ...
    try {
      ...
      if (mounted) {
        writeBookmarkEditTrace(
          ...
          traceId: _traceId,
          source: _traceSource,
          message: 'Bookmark editor panel save succeeded',
          topicId: widget.topicId,
          postId: widget.postId,
          bookmarkId: widget.bookmarkId,
      ...
      writeBookmarkEditTrace(
        ...
        traceId: _traceId,
        source: _traceSource,
        message: 'Bookmark editor panel save failed',
        topicId: widget.topicId,
        postId: widget.postId,
        bookmarkId: widget.bookmarkId,
      );
      ...
      writeBookmarkEditTrace(
        ...
        traceId: _traceId,
        source: _traceSource,
        message: 'Exception while saving bookmark editor panel',
        topicId: widget.topicId,
        postId: widget.postId,
        bookmarkId: widget.bookmarkId,
        error: e,
  ...
  Future<void> _delete() async {
    ...
    writeBookmarkEditTrace(
      ...
      traceId: _traceId,
      source: _traceSource,
      message: 'Bookmark editor panel started deleting bookmark',
      topicId: widget.topicId,
      postId: widget.postId,
      bookmarkId: widget.bookmarkId,
    );
    try {
      ...
      if (mounted) {
        writeBookmarkEditTrace(
          ...
          traceId: _traceId,
          source: _traceSource,
          message: 'Bookmark editor panel deleted bookmark successfully',
          topicId: widget.topicId,
          postId: widget.postId,
          bookmarkId: widget.bookmarkId,
          deleted: true,
      ...
      writeBookmarkEditTrace(
        ...
        traceId: _traceId,
        source: _traceSource,
        message: 'Bookmark editor panel failed to delete bookmark',
        topicId: widget.topicId,
        postId: widget.postId,
        bookmarkId: widget.bookmarkId,
      );
      ...
      writeBookmarkEditTrace(
        ...
        traceId: _traceId,
        source: _traceSource,
        message: 'Exception while deleting bookmark from editor panel',
        topicId: widget.topicId,
        postId: widget.postId,
        bookmarkId: widget.bookmarkId,
        error: e,
